...
public abstract class BaseAuthorPeerImpl
    extends org.apache.torque.util.BasePeerImpl<Author>
{
    /** The class log. */
    private static Log log = LogFactory.getLog(BaseAuthorPeerImpl.class);

    /** Serial version */
    private static final long serialVersionUID = 1650910343698L;
     ...
     */
    public List<Author> doSelect(Author obj)
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public Author doSelectSingleRecord(
                Author obj)
            throws TorqueException
    {
        List<Author> authorList = doSelect(obj);
        Author author = null;
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public void doInsert(Author obj) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public void doInsert(Author obj, Connection con)
        throws TorqueException
    {
        ...
        throws TorqueException
    {
        Criteria selectCriteria 
                = new Criteria(AuthorPeer.DATABASE_NAME);
        correctBooleans(columnValues);

        selectCriteria.where(
                AuthorPeer.AUTHOR_ID,
                columnValues.remove(AuthorPeer.AUTHOR_ID).getValue());
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public int doUpdate(Author obj) throws TorqueException
    {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public int doUpdate(Author obj, Connection con)
        throws TorqueException
    {
        ColumnValues columnValues = buildColumnValues(obj);
    ...
    public Criteria buildCriteria(ObjectKey pk)
    {
        ...
        criteria.and(AuthorPeer.AUTHOR_ID, pk);
        return criteria;
     }
    ...
    {
        Criteria criteria = new Criteria();
        criteria.andIn(AuthorPeer.AUTHOR_ID, pks);
        return criteria;
     }
    ...
    {
        Criteria criteria = new Criteria(AuthorPeer.DATABASE_NAME);
        if (!obj.isNew())
        {
            criteria.and(AuthorPeer.AUTHOR_ID, obj.getAuthorId());
        }
        ...
        throws TorqueException, NoRowsException, TooManyRowsException
    {
        ...
        try
        {
            connection = Transaction.begin(AuthorPeer.DATABASE_NAME);
        ...
        throws TorqueException, NoRowsException, TooManyRowsException
    {
        ...
        List<Author> v = doSelect(criteria, con);
        if (v.size() == 0)
        {
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public List<Author> retrieveByPKs(Collection<ObjectKey> pks)
        throws TorqueException
    {
        Connection connection = null;
        try
        {
            connection = Transaction.begin(AuthorPeer.DATABASE_NAME);
            List<Author> result = retrieveByPKs(pks, connection);
            Transaction.commit(connection);
            connection = null;
            return result;
        }
     ...
     *         rethrown wrapped into a TorqueException.
     */
    public List<Author> retrieveByPKs(
