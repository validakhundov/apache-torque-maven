            ...
            throws TorqueException
    {
        ...
        try 
        {
            ...
            if (criteria == null)
            {
                ...
                book.setTitle(
                        getTitle(resultSet, offset + 2));
                book.setISBN(
                        getISBN(resultSet, offset + 3));
                book.setPublisherId(
                        getPublisherId(resultSet, offset + 4));
                book.setAuthorId(
                        getAuthorId(resultSet, offset + 5));
            }
            else
            {
                ...
                for (Column column : columnsWithoutOffset)
                {
                    ...
                    else if (BaseBookPeer.ISBN.getSqlExpression().equals(
                            column.getSqlExpression()))
                    {
                        book.setISBN(
                            getISBN(resultSet, totalOffset));
                        columnMapped = true;
                    }
                    else if (BaseBookPeer.PUBLISHER_ID.getSqlExpression().equals(
                            column.getSqlExpression()))
                    {
                        book.setPublisherId(
                    ...
                    else if (BaseBookPeer.AUTHOR_ID.getSqlExpression().equals(
                            column.getSqlExpression()))
                    {
                        book.setAuthorId(
